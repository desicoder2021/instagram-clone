...
const Post = ({ post }) => {
  ...
  const likeOrDislikeHandler = async () => {
    try {
      // Determine the action : If already liked, user wants disliked otherwise liked
      const action = liked ? "dislike" : "like";
      // Send Get request to like or dislike the post
      ...
      if (res.data.success) {
        ...
        // Update the post data in the Redux store
        const updatedPostData = posts.map((p) =>
          p._id === post._id
            ? {
                ...p,
                // if the post was liked, remove the user's ID from the likes array, otherwise, add it
                likes: liked
  ...
  const commentHandler = async () => {
    try {
      ...
      if (res.data.success) {
        ...
        // Update the posts state by finding the matching post and updating its comments
        const updatedPostData = posts.map((p) =>
